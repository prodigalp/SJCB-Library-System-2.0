	...
	require("config.php");
		...
		if(isset($_POST['btnYes'])) {
			if("Yes"==$_POST['btnYes']) {
				...
				$q2 = "DELETE FROM tblhigh WHERE ctrlnum='$id'";
				mysql_query($q2);
...
<html>
<head>
<title>Delete Highschool Record</title>
<link rel="stylesheet" type="text/css" href="embelish/delete_highschool_record_decor.css"></link>
</head>
<body>
