<?php
	...
	$q1  = "SELECT * FROM tbluser t1, tblcollege t2 WHERE t1.id='$id' && t2.ctrlnum='$id'";
	$q2  = mysql_query($q1);
	...
	if(isset($_POST['btnUpd'])) {
		if("Update"==$_POST['btnUpd']) {
			...
			echo (" 
				...
				window.location='user_control_college.php';
				</script>
			");
		}
	}
...
<link rel="stylesheet" type="text/css" href="embelish/edit_control_college_decor.css"></link>
			...
			<table id="t1">
				...
				<tr>
					...
					<td><input type="text" name="Typ" id="Typ" size="15" 
						autocomplete="off" value="College" readonly></td>
				</tr>
				<tr>
					<td>Role:&nbsp;</td>
				...
				<tr>
					<td>Course:&nbsp;</td>
					<td><input type="text" name="txtCrs" id="txtCrs" size="35" 
						autocomplete="off" value="<?php echo $row->course;?>"></td>
				</tr>
				<tr>
					<td>Contact #:&nbsp;</td>
				...
				<tr id="btn">
					<td colspan="2">
						<a href="user_control_college.php" style="text-decoration:none">
