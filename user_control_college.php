...
<link rel="stylesheet" type="text/css" href="embelish/user_control_college_decor.css"></link>
		...
		<form method="POST" name="form1" id="form1">
				...
				<?php
					...
					if(isset($_POST['btnSnd'])) {
						if("Search"==$_POST['btnSnd']) {
							...
							$trans1 = "SELECT * FROM tbluser WHERE gtype='College' && fname like concat('$tle','%')";
			...
			?>			
				<tr id="r<?php echo $cntr;?>" onmouseover="c_ON(<?php echo $cntr;?>)" onmouseout="c_OFF(<?php echo $cntr;?>)">
					...
					<td id="shade">
						<a href="edit_control_college.php?id=<?php echo $disp['id'];?>"><img id="action" src="IMG/ICN/set (15).png" title="Click to update record"></a>
						<a href="delete_college_record.php?id=<?php echo $disp['id'];?>"><img id="action" src="IMG/ICN/set (5).png" title="Click to delete record" ></a>
