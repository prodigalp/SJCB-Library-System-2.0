...
if($_SESSION['role']=='4' || $_SESSION['role']=='3') {
	...
	$q1 = "SELECT gender,count(gender) as total FROM tblhigh GROUP BY gender ORDER BY total DESC;";
	$q2 = mysql_query($q1);
	
	// Use for displaying total number of books
	$r1 = "SELECT count(gender) as total FROM tblhigh";
	$r2 = mysql_query($r1);
...
<link rel="stylesheet" type="text/css" href="embelish/highschool_count_decor.css"></link>
...
<body>
	...
	<div id="header">High School Students</div>
		...
		<div id="header2">High School Students</div>
		
		
			<!--Display by book categories -->
			<table> 
				<tr><td colspan="2">List of registered high school students</td></tr>
				<tr id="liver1">
					<td>Gender</td>
					<td>Total</td>
				</tr>
