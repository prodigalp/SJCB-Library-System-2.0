...
if($_SESSION['role']=='4' || $_SESSION['role']=='3') {
	...
	$q1 = "SELECT gender,count(gender) as total FROM tblcollege GROUP BY gender ORDER BY total DESC;";
	$q2 = mysql_query($q1);
	
	// Use for displaying total number of books
	$r1 = "SELECT count(gender) as total FROM tblcollege";
	$r2 = mysql_query($r1);
...
<link rel="stylesheet" type="text/css" href="embelish/college_count_decor.css"></link>
...
<body>
	<div id="wraper">
	<div id="header">College Students</div>
		...
		<div id="header2">College Students</div>
		
		
			<!--Display by book categories -->
			<table> 
				<tr><td colspan="2">List of registered college students</td></tr>
				<tr id="liver1">
					<td>Gender</td>
					<td>Total</td>
				</tr>
